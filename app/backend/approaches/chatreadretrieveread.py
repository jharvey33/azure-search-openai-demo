...
class ChatReadRetrieveReadApproach(Approach):
    ...
    """
    system_message_chat_conversation = """Assistant helps the company employees with their cloud services deal questions. Be brief in your answers.
...
{injected_prompt}
"""
    follow_up_questions_prompt_content = """Generate three very brief follow-up questions that the user would likely ask next about their cloud services and pricing strategies.
Use double angle brackets to reference the questions, e.g. <<Are there any pay-per-use options?>>.
Try not to repeat questions that have already been asked.
Only generate questions and do not generate any text before or after the questions, such as 'Next Questions'"""

    query_prompt_template = """Below is a history of the conversation so far, and a new question asked by the user that needs to be answered by searching in a knowledge base about Cloud services and pricing strategies.
...
"""
    query_prompt_few_shots = [
        {"role": USER, "content": "What are the sales cloud products?"},
        {"role": ASSISTANT, "content": "Show available cloud products"},
        {"role": USER, "content": "What is the pricing scheme for Google Drive?"},
        {"role": ASSISTANT, "content": "Google drive pricing scheme"},
    ]
